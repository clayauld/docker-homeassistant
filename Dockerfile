...
ENV PIPFLAGS="--no-cache-dir --find-links https://wheel-index.linuxserver.io/alpine-3.15/ --find-links https://wheel-index.linuxserver.io/homeassistant-3.15/" PYTHONPATH="${PYTHONPATH}:/pip-packages"
